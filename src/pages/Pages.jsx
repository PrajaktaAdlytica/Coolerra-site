...
export function ContactPage() {
  return (
    <PageShell>
      <main className="contact-page section-shell"><div className="contact-page__visual" aria-hidden="true"><img src={visuals.boundary} alt="" /></div><div className="contact-page__copy"><p className="eyebrow">Contact Coolerra</p><h1>Start with the operating question.</h1><p>For product, pilot, company, and technical conversations, use the route that best matches what you need.</p></div><div className="contact-options"><a href="/demo"><ShieldCheck /><span><strong>Technical discovery</strong><small>Facility, telemetry, cooling, and pilot readiness</small></span><ArrowRight /></a><a href="mailto:hello@coolerra.com"><Mail /><span><strong>Company contact</strong><small>hello@coolerra.com</small></span><ArrowRight /></a><div><LockKeyhole /><span><strong>Location</strong><small>Poland / European Union</small></span></div></div></main>
    </PageShell>
  );
}
